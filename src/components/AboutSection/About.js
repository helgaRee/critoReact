    ...
    <section className="about">
      <div className="container">
        <div className="founder">
          <img
            className="wavy-lines-left"
            src={imgWavyLinesLeft}
            alt="Wavy lines, design"
          />
          <img src={imgAbout} alt="Image of the Founder, Samantha Brown" />
          <div className="background-frame">
            <p>
              <strong>Samantha Brown</strong>,<span>Founder</span>
              <br />
              <br />
        ...
        <div className="content">
          <SectionTitle
            title="About Company"
            description="We Are Business Consulting & Credit Repair Experts"
          />
