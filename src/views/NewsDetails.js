      ...
      <div className="menu-right container">
        <div>
          ...
          <div className="menu-top border">
            ...
            <h3><span className="underline">Rec</span>ent Posts</h3>
        ...
        <div>
          <div className="menu-bottom border">
            ...
            <h4>Technology -<span className="sub-text"> 20 Posts</span></h4>
            <h4>Freelancing -<span className="sub-text"> 20 Posts</span></h4>
            <h4>Writing -<span className="sub-text"> 20 Posts</span></h4>
            <h4>Marketing -<span className="sub-text"> 20 Posts</span></h4>
            <h4>Business -<span className="sub-text"> 20 Posts</span></h4>
            <h4>Education -<span className="sub-text"> 20 Posts</span></h4>
          </div>
        </div>
      </div>
      </section>
